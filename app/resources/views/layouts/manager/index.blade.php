...
<div class="list-group list-group-light">
  <a href="{{route('create')}}" class="list-group-item list-group-item-action px-3 border-0 active" aria-current="true">
    従業員登録へ</a>
  ...
  <a href="{{route('post')}}" class="list-group-item list-group-item-action px-3 border-0">お知らせ投稿作成へ</a>
